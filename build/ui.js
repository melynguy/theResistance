...
function showSearchMembersMenu(rm) {
    return _searchListMenu('member', function (query) { return rm.findMemberNames(query); });
}
function showSearchProtestsMenu(rm) {
    return _searchListMenu('protest', function (query) { return rm.findProtestNames(query); });
}
function showSearchMovementsMenu(rm) {
    return _searchListMenu('movement', function (query) { return rm.findMovementNames(query); });
}
